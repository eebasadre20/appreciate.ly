...
ActiveRecord::Schema.define(version: 20170723061048) do
  ...
  create_table "points_relationships", force: :cascade do |t|
    t.integer "giver_id"
    t.integer "receiver_id"
    t.integer "points"
    t.index ["giver_id"], name: "index_points_relationships_on_giver_id"
    t.index ["receiver_id"], name: "index_points_relationships_on_receiver_id"
  end
